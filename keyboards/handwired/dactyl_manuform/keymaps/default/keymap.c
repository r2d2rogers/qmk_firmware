 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      | Alt  | GUI  |Lower |Space |Space |Raise |   ,  |   ,  |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |Adjust|      |      |Raise |Bckspc|Space |Lower |      |      |Adjust|      |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = KEYMAP( \
  ...
  CTL_T(KC_ESC), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
        ...
        _______, _______, KC_LALT, KC_LGUI, LOWER,   F(0),    F(0),    RAISE,   KC_COMM, KC_DOT,  _______, _______, \
        _______, ADJUST,  _______, _______, RAISE,   KC_BSPC, KC_ENT,  LOWER,   _______, _______, ADJUST,  _______  \
),
