...
#define _________________MALTRON_L3________________       KC_Z, KC_SLSH, KC_J    KC_G,    KC_COMM
...
#define _____________NUMBER_SHIFT_LEFT_____________       KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC
#define _____________NUMBER_SHIFT_RIGHT____________       KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN
...
#define ________________GENERAL_BOTTOM_LEFT_________________          KC_LGUI,  KC_MEH, KC_LALT, KC_INS, SPACEFN, LOWER
