...
**WARNING:** This OLED Driver currently uses the new i2c_master driver from split common code. If your split keyboard uses i2c to communication between sides this driver will most likely cause a conflict (serial is fine). Please contact your keyboard vendor and ask them to migrate to the latest split common code to fix this. Message @mechmerlin#2999 in the qmk discord for more details. (ps: he likes rick-rolls)
...
bool oled_init_user(bool flip180) {
  return !is_keyboard_master(); // flips the display 180 degrees if offhand
}
