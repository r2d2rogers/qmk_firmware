...
//|--------+--------+--------+--------+--------+--------+        |        |        +--------+--------+--------+--------+--------+--------|
    _______, _________________FUNC_LEFT_________________,                             KC_F11, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
//|--------+--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+--------+--------|
    _______, _________________FUNC_RIGHT________________, _______,          _______,  KC_F12, _______, _______, _______, _______, _______,
//|--------+--------+--------+--------+--------+--------+        |        |        +--------+--------+--------+--------+--------+--------|
...
//,--------+--------+--------+--------+--------+--------+--------.        .--------+--------+--------+--------+--------+--------+--------.
    BL_TOGG, _________________FUNC_LEFT_________________,  KC_F11,           KC_F12, _________________FUNC_RIGHT________________, BL_TOGG,
//|--------+--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+--------+--------|
     BL_INC, _________________FUNC2_LEFT________________, _______,          _______, _________________FUNC2_RIGHT_______________,  BL_INC,
//|--------+--------+--------+--------+--------+--------+        |        |        +--------+--------+--------+--------+--------+--------|
