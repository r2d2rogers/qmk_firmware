...
[QWERTY_LAYER] = KEYMAP( \
  ...
  MO(UNDERGLOW_LAYER),  KC_MEH,   KC_LALT,  KC_LGUI,  F(3),     F(1),     F(2),     F(3),  MT(MOD_RGUI, KC_LEFT),  KC_DOWN,  KC_UP,    KC_RGHT \
),
...
[LOWER_LAYER] = KEYMAP( \
  ...
  TG(TENKEY_LAYER), KC_HYPR,   _______,  _______,  _______,  _______,  _______,  _______,  KC_HOME,  KC_PGDN,  KC_PGUP,  KC_END \
),
