...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_N    , KC_M   , KC_COMM , KC_DOT , KC_SLSH, KC_LSFT, TO(2)  ,
        KC_LCTL, KC_LGUI, KC_LALT, KC_LCTL, KC_SPC , KC_SPC , KC_SPC  , KC_RALT, KC_RGUI , KC_APP , KC_RCTL, KC_RCTL
        ),
    [1] = LAYOUT(
